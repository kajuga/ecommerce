...
public class CartController {
    ...
    public ResponseEntity<ApiResponse> addToCart(@AuthenticationPrincipal UserPrincipal userPrincipal, @RequestBody AddToCartDto addToCartDto, @RequestParam("token") String token)
